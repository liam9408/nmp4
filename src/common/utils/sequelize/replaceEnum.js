...
function unsetDefaultValueFromEnum(args) {
  return args.queryInterface.sequelize.query(
    getQueryToRemoveDefaultFromColumn(args.schema, args.tableName, args.columnName),
    args.sequelizeOptions
  );
}
/**
...
function setColumnTypeToEnum(args) {
  return args.queryInterface.sequelize.query(
    getQueryToSetEnumType(args.schema, args.tableName, args.columnName, args.enumName),
    args.sequelizeOptions
  );
}
/**
...
function getQueryToSetColumnDefault(schema, tableName, columnName, defaultValue, defaultValueType) {
  return `
    ALTER TABLE ${appendSchema(schema)}"${tableName}"
      ALTER COLUMN "${columnName}"
